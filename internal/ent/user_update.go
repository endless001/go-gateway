...
func (uu *UserUpdate) SetIsDelete(i int) *UserUpdate {
	uu.mutation.ResetIsDelete()
	uu.mutation.SetIsDelete(i)
	return uu
}

// AddIsDelete adds i to is_delete.
func (uu *UserUpdate) AddIsDelete(i int) *UserUpdate {
	uu.mutation.AddIsDelete(i)
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.AddedIsDelete(); ok {
...
// SetIsDelete sets the is_delete field.
func (uuo *UserUpdateOne) SetIsDelete(i int) *UserUpdateOne {
	uuo.mutation.ResetIsDelete()
	uuo.mutation.SetIsDelete(i)
	return uuo
}

// AddIsDelete adds i to is_delete.
func (uuo *UserUpdateOne) AddIsDelete(i int) *UserUpdateOne {
	uuo.mutation.AddIsDelete(i)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.AddedIsDelete(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: user.FieldIsDelete,
