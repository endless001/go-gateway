...
// ServiceInfoMutation represents an operation that mutate the ServiceInfos
// nodes in the graph.
type ServiceInfoMutation struct {
	config
	op            Op
	typ           string
	id            *int64
	...
	oldValue      func(context.Context) (*ServiceInfo, error)
	predicates    []predicate.ServiceInfo
}

var _ ent.Mutation = (*ServiceInfoMutation)(nil)

// serviceinfoOption allows to manage the mutation configuration using functional options.
type serviceinfoOption func(*ServiceInfoMutation)

// newServiceInfoMutation creates new mutation for $n.Name.
func newServiceInfoMutation(c config, op Op, opts ...serviceinfoOption) *ServiceInfoMutation {
	m := &ServiceInfoMutation{
		config:        c,
		op:            op,
		typ:           TypeServiceInfo,
		clearedFields: make(map[string]struct{}),
...
// withServiceInfoID sets the id field of the mutation.
func withServiceInfoID(id int64) serviceinfoOption {
	return func(m *ServiceInfoMutation) {
		var (
			err   error
			once  sync.Once
			value *ServiceInfo
		)
		m.oldValue = func(ctx context.Context) (*ServiceInfo, error) {
			once.Do(func() {
				if m.done {
					err = fmt.Errorf("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ServiceInfo.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withServiceInfo sets the old ServiceInfo of the mutation.
func withServiceInfo(node *ServiceInfo) serviceinfoOption {
	return func(m *ServiceInfoMutation) {
		m.oldValue = func(context.Context) (*ServiceInfo, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m ServiceInfoMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m ServiceInfoMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, fmt.Errorf("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that, this
// operation is accepted only on ServiceInfo creation.
func (m *ServiceInfoMutation) SetID(id int64) {
	m.id = &id
}

// ID returns the id value in the mutation. Note that, the id
// is available only if it was provided to the builder.
func (m *ServiceInfoMutation) ID() (id int64, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *ServiceInfoMutation) SetLoadType(i int) {
	m.load_type = &i
	m.addload_type = nil
}

// LoadType returns the load_type value in the mutation.
func (m *ServiceInfoMutation) LoadType() (r int, exists bool) {
	v := m.load_type
	if v == nil {
		return
	}
...
// OldLoadType returns the old load_type value of the ServiceInfo.
// If the ServiceInfo object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *ServiceInfoMutation) OldLoadType(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ServiceInfoMutation) AddLoadType(i int) {
...
func (m *ServiceInfoMutation) AddedLoadType() (r int, exists bool) {
	v := m.addload_type
	if v == nil {
		return
	}
...
func (m *ServiceInfoMutation) ResetLoadType() {
	m.load_type = nil
	m.addload_type = nil
}

// SetServiceName sets the service_name field.
func (m *ServiceInfoMutation) SetServiceName(s string) {
	m.service_name = &s
}

// ServiceName returns the service_name value in the mutation.
func (m *ServiceInfoMutation) ServiceName() (r string, exists bool) {
	v := m.service_name
	if v == nil {
		return
	}
...
// OldServiceName returns the old service_name value of the ServiceInfo.
// If the ServiceInfo object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *ServiceInfoMutation) OldServiceName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ServiceInfoMutation) ResetServiceName() {
	m.service_name = nil
}

// SetServiceDesc sets the service_desc field.
func (m *ServiceInfoMutation) SetServiceDesc(s string) {
	m.service_desc = &s
}

// ServiceDesc returns the service_desc value in the mutation.
func (m *ServiceInfoMutation) ServiceDesc() (r string, exists bool) {
	v := m.service_desc
	if v == nil {
		return
	}
...
// OldServiceDesc returns the old service_desc value of the ServiceInfo.
// If the ServiceInfo object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *ServiceInfoMutation) OldServiceDesc(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ServiceInfoMutation) ResetServiceDesc() {
	m.service_desc = nil
}

// SetCreateAt sets the create_at field.
func (m *ServiceInfoMutation) SetCreateAt(t time.Time) {
	m.create_at = &t
}

// CreateAt returns the create_at value in the mutation.
func (m *ServiceInfoMutation) CreateAt() (r time.Time, exists bool) {
	v := m.create_at
	if v == nil {
		return
	}
...
// OldCreateAt returns the old create_at value of the ServiceInfo.
// If the ServiceInfo object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *ServiceInfoMutation) OldCreateAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ServiceInfoMutation) ResetCreateAt() {
	m.create_at = nil
}

// SetUpdateAt sets the update_at field.
func (m *ServiceInfoMutation) SetUpdateAt(t time.Time) {
	m.update_at = &t
}

// UpdateAt returns the update_at value in the mutation.
func (m *ServiceInfoMutation) UpdateAt() (r time.Time, exists bool) {
	v := m.update_at
	if v == nil {
		return
	}
...
// OldUpdateAt returns the old update_at value of the ServiceInfo.
// If the ServiceInfo object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *ServiceInfoMutation) OldUpdateAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ServiceInfoMutation) ResetUpdateAt() {
	m.update_at = nil
}

// SetIsDelete sets the is_delete field.
func (m *ServiceInfoMutation) SetIsDelete(i int8) {
	m.is_delete = &i
	m.addis_delete = nil
}

// IsDelete returns the is_delete value in the mutation.
func (m *ServiceInfoMutation) IsDelete() (r int8, exists bool) {
	v := m.is_delete
	if v == nil {
		return
	}
...
// OldIsDelete returns the old is_delete value of the ServiceInfo.
// If the ServiceInfo object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *ServiceInfoMutation) OldIsDelete(ctx context.Context) (v int8, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ServiceInfoMutation) AddIsDelete(i int8) {
...
func (m *ServiceInfoMutation) AddedIsDelete() (r int8, exists bool) {
	v := m.addis_delete
	if v == nil {
		return
	}
...
func (m *ServiceInfoMutation) ResetIsDelete() {
	m.is_delete = nil
	m.addis_delete = nil
}

// Op returns the operation name.
func (m *ServiceInfoMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (ServiceInfo).
func (m *ServiceInfoMutation) Type() string {
	return m.typ
}
...
// this mutation. Note that, in order to get all numeric
// fields that were in/decremented, call AddedFields().
func (m *ServiceInfoMutation) Fields() []string {
	fields := make([]string, 0, 6)
	if m.load_type != nil {
		fields = append(fields, serviceinfo.FieldLoadType)
	}
	if m.service_name != nil {
		fields = append(fields, serviceinfo.FieldServiceName)
	}
	if m.service_desc != nil {
		fields = append(fields, serviceinfo.FieldServiceDesc)
	}
	if m.create_at != nil {
		fields = append(fields, serviceinfo.FieldCreateAt)
	}
	if m.update_at != nil {
		fields = append(fields, serviceinfo.FieldUpdateAt)
	}
	if m.is_delete != nil {
		fields = append(fields, serviceinfo.FieldIsDelete)
	}
	return fields
}
...
// The second boolean value indicates that this field was
// not set, or was not define in the schema.
func (m *ServiceInfoMutation) Field(name string) (ent.Value, bool) {
	switch name {
	case serviceinfo.FieldLoadType:
		return m.LoadType()
	case serviceinfo.FieldServiceName:
		return m.ServiceName()
	case serviceinfo.FieldServiceDesc:
		return m.ServiceDesc()
	case serviceinfo.FieldCreateAt:
		return m.CreateAt()
	case serviceinfo.FieldUpdateAt:
		return m.UpdateAt()
	case serviceinfo.FieldIsDelete:
		return m.IsDelete()
	}
	return nil, false
}
...
// An error is returned if the mutation operation is not UpdateOne,
// or the query to the database was failed.
func (m *ServiceInfoMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case serviceinfo.FieldLoadType:
	...
	return nil, fmt.Errorf("unknown ServiceInfo field %s", name)
}

// SetField sets the value for the given name. It returns an
// error if the field is not defined in the schema, or if the
// type mismatch the field type.
func (m *ServiceInfoMutation) SetField(name string, value ent.Value) error {
	switch name {
	case serviceinfo.FieldLoadType:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown ServiceInfo field %s", name)
}

// AddedFields returns all numeric fields that were incremented
// or decremented during this mutation.
func (m *ServiceInfoMutation) AddedFields() []string {
	var fields []string
	if m.addload_type != nil {
		fields = append(fields, serviceinfo.FieldLoadType)
	}
...
// from a field with the given name. The second value indicates
// that this field was not set, or was not define in the schema.
func (m *ServiceInfoMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case serviceinfo.FieldLoadType:
...
// error if the field is not defined in the schema, or if the
// type mismatch the field type.
func (m *ServiceInfoMutation) AddField(name string, value ent.Value) error {
	switch name {
	case serviceinfo.FieldLoadType:
		v, ok := value.(int)
		if !ok {
	...
	return fmt.Errorf("unknown ServiceInfo numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared
// during this mutation.
func (m *ServiceInfoMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicates if this field was
// cleared in this mutation.
func (m *ServiceInfoMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value for the given name. It returns an
// error if the field is not defined in the schema.
func (m *ServiceInfoMutation) ClearField(name string) error {
	return fmt.Errorf("unknown ServiceInfo nullable field %s", name)
}

// ResetField resets all changes in the mutation regarding the
// given field name. It returns an error if the field is not
// defined in the schema.
func (m *ServiceInfoMutation) ResetField(name string) error {
	switch name {
	case serviceinfo.FieldLoadType:
		m.ResetLoadType()
		return nil
...
// AddedEdges returns all edge names that were set/added in this
// mutation.
func (m *ServiceInfoMutation) AddedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// AddedIDs returns all ids (to other nodes) that were added for
// the given edge name.
func (m *ServiceInfoMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this
// mutation.
func (m *ServiceInfoMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all ids (to other nodes) that were removed for
// the given edge name.
func (m *ServiceInfoMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this
// mutation.
func (m *ServiceInfoMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean indicates if this edge was
// cleared in this mutation.
func (m *ServiceInfoMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value for the given name. It returns an
// error if the edge name is not defined in the schema.
func (m *ServiceInfoMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown ServiceInfo unique edge %s", name)
}

// ResetEdge resets all changes in the mutation regarding the
// given edge name. It returns an error if the edge is not
// defined in the schema.
func (m *ServiceInfoMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown ServiceInfo edge %s", name)
}
...
// SetID sets the value of the id field. Note that, this
// operation is accepted only on Tenant creation.
...
func (m *TenantMutation) SetAppID(s string) {
	m.app_id = &s
}

// AppID returns the app_id value in the mutation.
func (m *TenantMutation) AppID() (r string, exists bool) {
	v := m.app_id
	if v == nil {
		return
	}
...
// OldAppID returns the old app_id value of the Tenant.
// If the Tenant object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TenantMutation) OldAppID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TenantMutation) ResetAppID() {
	m.app_id = nil
}
...
func (m *TenantMutation) SetSecret(s string) {
	m.secret = &s
}

// Secret returns the secret value in the mutation.
func (m *TenantMutation) Secret() (r string, exists bool) {
	v := m.secret
	if v == nil {
		return
	}
...
// OldSecret returns the old secret value of the Tenant.
// If the Tenant object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TenantMutation) OldSecret(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TenantMutation) ResetSecret() {
	m.secret = nil
}

// SetWhiteIps sets the white_ips field.
func (m *TenantMutation) SetWhiteIps(s string) {
	m.white_ips = &s
}

// WhiteIps returns the white_ips value in the mutation.
func (m *TenantMutation) WhiteIps() (r string, exists bool) {
	v := m.white_ips
	if v == nil {
		return
	}
...
// OldWhiteIps returns the old white_ips value of the Tenant.
// If the Tenant object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TenantMutation) OldWhiteIps(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TenantMutation) ResetWhiteIps() {
	m.white_ips = nil
}

// SetQpd sets the qpd field.
func (m *TenantMutation) SetQpd(i int) {
	m.qpd = &i
	m.addqpd = nil
}

// Qpd returns the qpd value in the mutation.
func (m *TenantMutation) Qpd() (r int, exists bool) {
	v := m.qpd
	if v == nil {
		return
	}
...
// OldQpd returns the old qpd value of the Tenant.
// If the Tenant object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TenantMutation) OldQpd(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TenantMutation) AddQpd(i int) {
	if m.addqpd != nil {
		*m.addqpd += i
	} else {
		m.addqpd = &i
...
func (m *TenantMutation) AddedQpd() (r int, exists bool) {
	v := m.addqpd
	if v == nil {
		return
	}
...
func (m *TenantMutation) ResetQpd() {
	m.qpd = nil
	m.addqpd = nil
}
...
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TenantMutation) OldQPS(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
// SetCreateAt sets the create_at field.
func (m *TenantMutation) SetCreateAt(t time.Time) {
	m.create_at = &t
}

// CreateAt returns the create_at value in the mutation.
func (m *TenantMutation) CreateAt() (r time.Time, exists bool) {
	v := m.create_at
	if v == nil {
		return
	}
...
// OldCreateAt returns the old create_at value of the Tenant.
// If the Tenant object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TenantMutation) OldCreateAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldCreateAt is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreateAt reset all changes of the "create_at" field.
func (m *TenantMutation) ResetCreateAt() {
	m.create_at = nil
}

// SetUpdateAt sets the update_at field.
func (m *TenantMutation) SetUpdateAt(t time.Time) {
	m.update_at = &t
}

// UpdateAt returns the update_at value in the mutation.
func (m *TenantMutation) UpdateAt() (r time.Time, exists bool) {
	v := m.update_at
	if v == nil {
		return
	}
...
// OldUpdateAt returns the old update_at value of the Tenant.
// If the Tenant object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TenantMutation) OldUpdateAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldUpdateAt is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdateAt reset all changes of the "update_at" field.
func (m *TenantMutation) ResetUpdateAt() {
	m.update_at = nil
}

// SetIsDelete sets the is_delete field.
func (m *TenantMutation) SetIsDelete(i int8) {
	m.is_delete = &i
	m.addis_delete = nil
}

// IsDelete returns the is_delete value in the mutation.
func (m *TenantMutation) IsDelete() (r int8, exists bool) {
	v := m.is_delete
	if v == nil {
		return
	}
...
// OldIsDelete returns the old is_delete value of the Tenant.
// If the Tenant object wasn't provided to the builder, the object is fetched
// from the database.
// An error is returned if the mutation operation is not UpdateOne, or database query fails.
func (m *TenantMutation) OldIsDelete(ctx context.Context) (v int8, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldIsDelete is allowed only on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AddIsDelete adds i to is_delete.
func (m *TenantMutation) AddIsDelete(i int8) {
	if m.addis_delete != nil {
		*m.addis_delete += i
	} else {
		m.addis_delete = &i
...
// AddedIsDelete returns the value that was added to the is_delete field in this mutation.
func (m *TenantMutation) AddedIsDelete() (r int8, exists bool) {
	v := m.addis_delete
	if v == nil {
		return
	}
...
// ResetIsDelete reset all changes of the "is_delete" field.
func (m *TenantMutation) ResetIsDelete() {
	m.is_delete = nil
	m.addis_delete = nil
}
...
func (m *TenantMutation) Fields() []string {
	...
	if m.app_id != nil {
		fields = append(fields, tenant.FieldAppID)
	}
	if m.name != nil {
		fields = append(fields, tenant.FieldName)
	}
	if m.secret != nil {
		fields = append(fields, tenant.FieldSecret)
	}
	if m.white_ips != nil {
		fields = append(fields, tenant.FieldWhiteIps)
	}
	if m.qpd != nil {
	...
	if m.create_at != nil {
		fields = append(fields, tenant.FieldCreateAt)
	}
	if m.update_at != nil {
		fields = append(fields, tenant.FieldUpdateAt)
	}
	if m.is_delete != nil {
		fields = append(fields, tenant.FieldIsDelete)
	}
	return fields
}
...
func (m *TenantMutation) Field(name string) (ent.Value, bool) {
	switch name {
	case tenant.FieldAppID:
		return m.AppID()
	case tenant.FieldName:
		return m.Name()
	case tenant.FieldSecret:
		return m.Secret()
	case tenant.FieldWhiteIps:
		return m.WhiteIps()
	case tenant.FieldQpd:
		return m.Qpd()
	case tenant.FieldQPS:
		return m.QPS()
	case tenant.FieldCreateAt:
		return m.CreateAt()
	case tenant.FieldUpdateAt:
		return m.UpdateAt()
	case tenant.FieldIsDelete:
		return m.IsDelete()
	}
	return nil, false
}
